...
const Addtraining = (props) => {
    ...
    const handleClickOpen = () => {
        setTraining({...training, duration: '15', sdate: moment().format('YYYY-MM-DDTHH:MM'), who: props.customer.firstname + ' ' + props.customer.lastname, customer: props.customer.links[0].href})
        setOpen(true);
    };
